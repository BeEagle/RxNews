...
import com.yuqirong.rxnews.ui.adapter.DragGridAdapter;
...
public class DragGridView extends GridView implements AdapterView.OnItemLongClickListener {
    ...
    private void initWindow() {
        if (dragView == null) {
            dragView = View.inflate(getContext(), R.layout.layout_channel_item, null);
        ...
        if (layoutParams == null) {
            ...
            layoutParams.y = view.getTop() + this.getTop() + windowHeight;  //悬浮窗Y的位置
    ...
    private void updateWindow(MotionEvent ev) {
        if (mode == MODE_DRAG) {
            ...
            if (layoutParams != null) {
                ...
                layoutParams.y = (int) y + windowHeight;
